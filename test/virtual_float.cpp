...
TEST(virtual_float, from_virtual_float)
{
    {
        cdsp::virtual_float<q4_20> a{2.0f};
		constexpr auto convert_operator = cnl::convert_operator<
				cnl::power<-20, 2>,
				cnl::power<0, 2>,
				cnl::_impl::number<cnl::elastic_integer<24, int>, cnl::nearest_rounding_tag>,
				cdsp::virtual_float<cnl::scaled_integer<cnl::_impl::number<cnl::elastic_integer<24, int>, cnl::nearest_rounding_tag>, cnl::power<-20, 2> > >>{};
		q4_20 b = convert_operator(a);
...
static_assert(
		cnl::numeric_limits<cdsp::virtual_float<int>>::is_specialized,
		"");
